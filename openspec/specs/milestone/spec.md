...
## Purpose
Define the Milestone domain model representing concrete checkpoints within goals with specific target dates, enabling progress tracking through linked commitments and automatic missed-deadline detection.
## Requirements
