...
The Integrity Protocol implements MPI's Honor-Your-Word framework with time-based coaching. It provides integrity metrics, task history logging, estimation accuracy tracking, and AI coaching context.
