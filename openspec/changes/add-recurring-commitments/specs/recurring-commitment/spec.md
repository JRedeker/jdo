# Capability: Recurring Commitment Management

Recurring commitments are templates with schedules that spawn individual Commitment instances on-demand. They enable users to track regular obligations without manually creating each instance.
