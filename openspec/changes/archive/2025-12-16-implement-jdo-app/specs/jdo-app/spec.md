...
The JDO application shell provides the main entry point and orchestrates screen navigation, database initialization, and application lifecycle management. It integrates all TUI screens (Home, Chat, Settings) into a cohesive user experience.
