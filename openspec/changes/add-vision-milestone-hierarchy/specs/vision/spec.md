# Capability: Vision Management

Visions represent the top of the MPI planning hierarchy - a vivid, inspiring picture of the future that ignites passion and guides all goals and commitments. Visions are long-term (typically 3-5+ years) and stable, reviewed quarterly to ensure they remain relevant and motivating.
